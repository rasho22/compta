...
$app->match('/admin/depense/{id}/edit', "app_compta\Controller\AdminController::editDepenseAction")->bind('admin_depense_edit');

//add a depense
$app->get('/admin/depense/add', "compta\Controller\AdminController::addDepenseAction");
